...
class DNNCRF(nn.Module):
    def __init__(self, DNN, num_classes=1, num_nodes=1, use_crf=True):
        super(DNNCRF, self).__init__()
        if DNN == 'ResNet':
            self.base_model = torchvision.models.resnet50()
        else:
            self.base_model = torchvision.models.densenet121()

...
import torch
import ttach as tta
from My_cams.pytorch_grad_cam.activations_and_gradients import ActivationsAndGradients
from My_cams.pytorch_grad_cam.utils.svd_on_activations import get_2d_projection
...
class BaseCAM:
    ...
    def compute_cam_per_layer(
        ...
        if isinstance(input_tensor, tuple):
            target_size = self.get_target_width_height(input_tensor[0])
        else:

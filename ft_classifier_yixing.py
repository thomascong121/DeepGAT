...
def runner(cfg: DictConfig):
    ...
    model_save_path = os.path.join(cfg.Training.checkpoint_dir, 'Scratch_ReNet34GATpool+patchInfer_torch.pt') # Yixing
    #model_save_path = os.path.join(cfg.Training.checkpoint_dir, 'Scratch_ReNet50GATpool+patchInfer_torch.pt')
    #model_save_path = os.path.join(cfg.Training.checkpoint_dir, 'Scratch_DenseGATpool+patchInfer_torch.pt')
